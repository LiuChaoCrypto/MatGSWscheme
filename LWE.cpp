...
std::shared_ptr<LWESecretKey_uint16> LWEEncryptionScheme_uint16::KeyGen(
	...
	LWESecretKey_uint16 sec;
	vector<uint16_t> secret(n);
	...
	sec.Sets(secret);
	return make_shared<LWESecretKey_uint16>(sec);
}

std::shared_ptr<LWECiphertext_uint16> LWEEncryptionScheme_uint16::Encrypt(
...
void LWEEncryptionScheme_uint16::Decrypt(const std::shared_ptr<LWEparams_uint16> params,
	const std::shared_ptr<const LWESecretKey_uint16> sk,
