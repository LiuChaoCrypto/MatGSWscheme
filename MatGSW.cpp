...
std::shared_ptr<MatGSWSecretKey_uint16> MatGSWEncryptionScheme_uint16::KeyGen(
	const std::shared_ptr<MatGSWparams_uint16> params) const {

	uint32_t q = params->Getq();
	uint32_t N = params->GetN();

	MatGSWSecretKey_uint16 sec;
	...
	sec.SetS(secret);
	return make_shared<MatGSWSecretKey_uint16>(sec);
}

std::shared_ptr<MatGSWCiphertext_uint16> MatGSWEncryptionScheme_uint16::Encrypt_Fast(
	...
	vector<vector<uint16_t>> M = m->GetM();
	vector<vector<uint16_t>> G(N + q);
...
std::shared_ptr<MatGSWPlaintext_uint16> MatGSWEncryptionScheme_uint16::SetPerM(
	const std::shared_ptr<MatGSWparams_uint16> params, const uint32_t m) const {

	uint32_t q = params->Getq();
	if (m > q)cout << "wrong in SetM m>q!";

	MatGSWPlaintext_uint16 plain;
...
void MatGSWEncryptionScheme_uint16::Decrypt(const std::shared_ptr<MatGSWparams_uint16> params,
	...
	uint32_t Q = params->GetQ();
	vector<vector<uint16_t>> S=sk->GetS();
	vector<vector<uint16_t>> A = ct->GetA();
	vector<vector<uint16_t>> B = ct->GetB();
...
std::shared_ptr<MatGSWCiphertext_uint16> MatGSWEncryptionScheme_uint16::MatAdd(
	const std::shared_ptr<MatGSWparams_uint16> params,
	...
	vector<vector<uint16_t>> A2 = cipher2->GetA();
	vector<vector<uint16_t>> B2 = cipher2->GetB();
 ...
 vector<uint16_t> Ginverse_uint16(uint16_t number, long l) {

	uint16_t testnumber=number,inter;
...
//	 cout << "\n infunc vecinv=" << vecinv;
	 ...
	 {
		 inv = Ginverse_uint16(vec_number[i], l);
		 copy( inv.begin(), inv.end(),vecinv.begin() + i * l);
	 }
	 return vecinv;
 };

 vector<vector<uint16_t>> matGinverse_uint16(vector<vector<uint16_t>> mat_number, long row, long colum, long l) {

	 vector<vector<uint16_t>> matinv(colum);
	 vector<vector<uint16_t>> mat_number_T(colum);
...
std::shared_ptr<MatGSWCiphertext_uint16> MatGSWEncryptionScheme_uint16::MatMul(
	const std::shared_ptr<MatGSWparams_uint16> params,
	const std::shared_ptr<const MatGSWCiphertext_uint16> cipher1,
	const std::shared_ptr<const MatGSWCiphertext_uint16> cipher2) const {
	...
	vector<vector<uint16_t>> C2inverse = matGinverse_uint16(C2, N + q, (N + q) * l, l);
...
std::shared_ptr<VecLWECiphertext_uint16> MatGSWEncryptionScheme_uint16::MatVecMul(
	const std::shared_ptr<MatGSWparams_uint16> params,
...
uint16_t MatGSWEncryptionScheme_uint16::VecVecMul(
	const std::shared_ptr<MatGSWparams_uint16> params,
	const std::shared_ptr<VecLWEparams_uint16> params2,
